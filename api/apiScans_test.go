...
func TestConfigureScan(t *testing.T) {
	...
	createdScan, err := client.ConfigureScan(httpClient, 12, `{"uuid":"ad629e16-03b6-8c1d-cef6-ef8c9dd3c658d24bd260ef5f9e66","settings":{"name":"Example Scan", "text_targets":"localhost"}}`)

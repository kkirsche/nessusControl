...
func TestConfigurePolicy(t *testing.T) {
	...
	configuredPolicy, err := client.ConfigurePolicy(httpClient, 33, `{"uuid":"ad629e16-03b6-8c1d-cef6-ef8c9dd3c658d24bd260ef5f9e66","settings": {"acls": []}}`)
	if err != nil || configuredPolicy != true {
		t.FailNow()
	}
}
